...
"Aline no País das Artes" é um jogo desenvolvido por um grupo de quatro pessoas, com o objetivo de entreter, divertir e ensinar sobre artes ao jogador. O jogador assume o papel de uma garota que está estudando para um exame de graduação em artes. Durante seus estudos, ela acaba cochilando e, como em "Alice no País das Maravilhas", desperta em um mundo mágico, agora repleto de desafios artísticos. O projeto é um jogo 2D produzido utilizando linguagem C e a biblioteca Allegro 5
...
Desenvolvido por um conjunto de 4 pessoas:
- Alvaro
- Eduardo
- Gabriel
- Juliano
